...
% Sally code listings
\input{sally-listing-config}
% LIMA code listings
\input{lima-listing-config}
% TEXT code listings
\input{text-listing-config}
...
\affiliation{Groq, Inc.}
\author{Srivatsan Varadarajan\footnote{Staff Scientist. Honeywell Advanced Technology, 1985 Douglas Dr. N, Golden Valley, Minnesota, 55422.} and Brendan Hall\footnote{Engineer Fellow. Honeywell Advanced Technology, 1985 Douglas Dr. N, Golden Valley, Minnesota, 55422.}} \affiliation{Honeywell Advanced Technology}
